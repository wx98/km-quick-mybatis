...
<!-- Plugin description -->
* Km-Quick-Mybatis 是一款 IntelliJ IDEA 插件，用于快速实现 Java 类与 MyBatis Mapper 文件之间的互相跳转。
...
- Using the IDE built-in plugin system:
  ...
  <kbd>Settings/Preferences</kbd> > <kbd>Plugins</kbd> > <kbd>Marketplace</kbd> > <kbd>Search for "km-quick-mybatis"</kbd> >
  <kbd>Install</kbd>
