...
- 使用 IDE 内置插件系统：
  ...
  <kbd>设置/偏好设置</kbd> > <kbd>插件</kbd> > <kbd>市场</kbd> > <kbd>搜索 "km-quick-mybatis"</kbd> >
  <kbd>安装</kbd>
  
- 使用 JetBrains 插件市场：

  访问 [JetBrains 插件市场](https://plugins.jetbrains.com/plugin/28263-km-quick-mybatis)，如果您的 IDE 正在运行，点击 <kbd>安装到 ...</kbd> 按钮进行安装。

  您也可以从 JetBrains 插件市场下载 [最新版本](https://plugins.jetbrains.com/plugin/28263-km-quick-mybatis/versions) 并手动安装：
