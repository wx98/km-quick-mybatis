 ...
 * 测试MyBatis XML解析器的功能
 */
@TestDataPath("$CONTENT_ROOT/src/test/resources/cn/wx1998/kmerit/jetbrains/plugins/quickmybatis/parser/")
...
//            fail("解析无效文件应该抛出IllegalArgumentException异常");
    ...
    protected String getTestDataPath() {
        return "src/test/resources/cn/wx1998/kmerit/jetbrains/plugins/quickmybatis/parser/"; // 确保使用正确的测试数据路径
    }
}