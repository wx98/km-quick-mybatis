...
### Using JetBrains Marketplace:
  <a href="https://plugins.jetbrains.com/plugin/29383-km-quick-mybatis" target="_blank"><img src="./.github/readme/install-button-en.png" height="52" alt="Get from Marketplace" title="Get from Marketplace"></a>
...
- <kbd>Settings/Preferences</kbd> → <kbd>Plugins</kbd> → <kbd>Marketplace</kbd> → <kbd>Search for "km-quick-mybatis"</kbd> → <kbd>Install</kbd>  
  <img src="./.github/readme/install-plugins-in-ide-en.png" height="500">
